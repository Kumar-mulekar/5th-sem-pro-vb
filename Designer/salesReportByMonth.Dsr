VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} salesReportByMonth 
   Bindings        =   "salesReportByMonth.dsx":0000
   Caption         =   "salesReportByMonth"
   ClientHeight    =   9645
   ClientLeft      =   60
   ClientTop       =   405
   ClientWidth     =   10605
   ...
   TopMargin       =   1440
   BottomMargin    =   1440
   DataMember      =   "salesReportByMonthcmd"
   NumSections     =   5
   SectionCode0    =   1
   ...
   EndProperty
End
Attribute VB_Name = "salesReportByMonth"
